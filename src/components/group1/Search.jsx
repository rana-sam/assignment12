    ...
    return (
        <div className='row searchgroup pb-5'>
            ...
            <div className='col-5 pt-5 mt-5'>
                ...
                <p className='group1p pt-4'>Online Estate Agency, the modern way to sell your own home. You can use griffin residential to market your property.</p>
                <div className="row pt-4 pb-5">
                    ...
                    <div className="col-4 pt-3">
                        <button className='btn ps-4 pt-2 pb-2 pe-4 text-white bg-primary'>Search</button>
                    </div>
                </div>
                </div>
            <div className='col-5'>
